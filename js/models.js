...
class StoryList {
  ...
  async addStory(user, {author, title, url} ) {
    ...
    this.stories.unshift(story); // updates the story lists
    user.ownStories.unshift(story);  // updates the own story
  ...
  async deleteAstory(user, storyId) {
    ...
    await axios({
      ...
      data: { token }
        ...
        // filter out the story whose ID we are removing from story list, own story and favorite story list
    this.stories = this.stories.filter(story => story.storyId !== storyId);

    user.ownStories = user.ownStories.filter(s => s.storyId !== storyId);
    
    
    user.favorites = user.favorites.filter(s => s.storyId !== storyId);  // may not really be present here
  }
...
class User {
  ...
  // makes POST request to favorite a story 
  ...
  // makes a DELETE request to unfavorite a story
